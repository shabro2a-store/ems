...
export async function PATCH(req: Request, ctx: { params: { id: string } }) {
  ...
  await writeAuditLog({
    ...
    entity: 'Branch',
    entityId: branch.id,
    before: { name: before.name, lat: before.lat, lng: before.lng, gps_radius_m: before.gps_radius_m, gps_accuracy_max_m: before.gps_accuracy_max_m, absent_grace_min: before.absent_grace_min, trip_threshold_min: before.trip_threshold_min, is_active: before.is_active },
    after: { name: branch.name, lat: branch.lat, lng: branch.lng, gps_radius_m: branch.gps_radius_m, gps_accuracy_max_m: branch.gps_accuracy_max_m, absent_grace_min: branch.absent_grace_min, trip_threshold_min: branch.trip_threshold_min, is_active: branch.is_active },
  });
